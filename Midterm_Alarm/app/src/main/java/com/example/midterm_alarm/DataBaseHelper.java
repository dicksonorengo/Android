...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public Data getContent(long id) {
        ...
        Cursor cursor = db.query(Data.TABLE_NAME, new String[]{Data.COLUMN_ID, Data.COLUMN_DESCRIPTION, Data.COLUMN_TIME},
                Data.COLUMN_ID + "=?", new String[]{String.valueOf(id)}, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
        Data note = new Data(
    ...
    public int updateContent (Data content) {
        ...
        values.put(Data.COLUMN_DESCRIPTION, content.getDescription());
        values.put(Data.COLUMN_TIME, content.getTime());
        return db.update(Data.TABLE_NAME, values, Data.COLUMN_ID + " = ?", new String[]{String.valueOf(content.getId())});
    }
    public void deleteContent(Data content) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(Data.TABLE_NAME, Data.COLUMN_ID + " = ?", new String[]{String.valueOf(content.getId())});
        db.close();
    }
}