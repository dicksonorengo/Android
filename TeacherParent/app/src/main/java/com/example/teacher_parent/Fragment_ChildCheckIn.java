...
public class Fragment_ChildCheckIn extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView =v.findViewById(R.id.child_checkin_recyclerview);
        ...
        classesTb.child(currentClass).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                checked_in_list = new ArrayList<>(Arrays.asList(dataSnapshot.child("checked_in").getValue().toString().split(",")));
                checked_out_list =  new ArrayList<>(Arrays.asList(dataSnapshot.child("checked_out").getValue().toString().split(",")));
                absent_list =  new ArrayList<>(Arrays.asList(dataSnapshot.child("absent").getValue().toString().split(",")));
            }
            @Override
