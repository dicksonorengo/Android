...
public class Fragment_Child_CustomActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TaggedKids_TV = view.findViewById(R.id.Act_taggedKids);
        SetChildData();


        ActivityName = view.findViewById(R.id.CustomAct_Name);
        ActivityDetails =  view.findViewById(R.id.CustomAct_Details);
        Hours =  view.findViewById(R.id.Act_hours);
        Minutes =  view.findViewById(R.id.Act_minutes);

        AmPmSelector =  view.findViewById(R.id.Act_ampm_dropdown);

        final LinearLayout CustomTimeEdit =  view.findViewById(R.id.Act_CustomTimeLayout);
        CustomTimeEdit.setVisibility(view.GONE);

        RadioGroup TimeSelector =  view.findViewById(R.id.Act_timegroup);
        CurrentTime =  view.findViewById(R.id.Act_CurrTimeRadio);
        CustomTime =  view.findViewById(R.id.Act_CustTimeRadio);
        ...
        Button addButton = view.findViewById(R.id.button_AddCustomActivity);
    ...
    private void AddNewActivity(String Act_time)
    {
        ...
        databaseReference.child(MyActId).child("type").setValue("HomeWork");
