...
public class Fragment_Nap_Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TaggedKids_TV = view.findViewById(R.id.Nap_taggedKids);
        SetChildData();

        // Spinners
        Start_AmPmSelector = view.findViewById(R.id.Nap_Start_ampm_dropdown);
        End_AmPmSelector = view.findViewById(R.id.Nap_End_ampm_dropdown);

        // Edittext fields
        Start_hours =  view.findViewById(R.id.Nap_Start_hours);
        Start_minutes =  view.findViewById(R.id.Nap_Start_minutes);

        End_hours =  view.findViewById(R.id.Nap_End_hours);
        End_minutes = view.findViewById(R.id.Nap_End_minutes);

        Nap_Details =  view.findViewById(R.id.Nap_Details);

        Button addPost =  view.findViewById(R.id.Nap_AddPost);
    ...
    private void AddNapPost(String startTime, String EndTime)
    {
        ...
        databaseReference.child(MyActId).child("type").setValue("Schedule");
