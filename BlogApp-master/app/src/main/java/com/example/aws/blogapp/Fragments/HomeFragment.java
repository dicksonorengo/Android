    ...
    public void onStart() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String allpost = dataSnapshot.child("admin").child(uid).child("posts").getValue().toString();
                //System.out.println("()())()))())()" + dataSnapshot.child("admin").child(uid).child("posts").getValue().toString());
